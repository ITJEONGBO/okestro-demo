...
enum class Term(
	...
	ROLE("역할"),
	FILE("파일"),
	OPEN_STAK_IMAGE_PROVIDER("오픈스택 이미지 공급자"),
	OPEN_STAK_NETWORK_PROVIDER("오픈스택 네트워크 공급자"),
	OPEN_STAK_VOLUME_PROVIDER("오픈스택 볼륨 공급자"),
...
fun Term.logFail(action: String, t: Throwable? = null, target: String = "") {
	if (t == null)
		...
		log.error("실패: {} {} ... {}, 이유: {}", this@logFail.desc, action, target, t.localizedMessage)
