...
<div class="right_col" role="main" id="targetInstanceType">
						...
						<div class="form-horizontal form-label-left">
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<input type="text" class="form-control" v-model="targetInstanceType.name" @input="checkInstanceName" placeholder="이름" :maxlength="this.$maxName" required>
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<input type="text" class="form-control" v-model="targetInstanceType.description" placeholder="설명">
								</div>
							</div>
							<hr>
							<p>
							...
							<div class="form-group">
								...
								<div class="col-md-5 col-sm-5 col-xs-12">
									<select class="form-control" v-model="nic" disabled>
										...
										<option v-for="nic in targetInstanceType.nics" v-bind:value="nic">{{nic.networkName}}</option>
									</select>
								</div>
							</div>
						</div>
						...
						<form class="form-horizontal form-label-left">
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<select class="form-control" v-model="targetInstanceType.affinity">
							...
							<div class="form-group">
								<div class="checkbox">
									...
									<div class="col-md-7 col-sm-7 col-xs-12">
										<select class="form-control" :disabled="!targetInstanceType.customMigrationUsed" v-model="targetInstanceType.customMigration">
								...
								<div class="checkbox">
									<div class="col-md-5 col-sm-5 col-xs-12">
										<label><input type="checkbox"
											:disabled="!targetInstanceType.customMigrationUsed"
											v-model="targetInstanceType.customMigrationDowntimeUsed"> 사용자 정의 마이그레이션 다운 타임
									...
									<div class="col-md-7 col-sm-7 col-xs-12">
										<input type="text" class="form-control" placeholder=""
											:disabled="!targetInstanceType.customMigrationDowntimeUsed || !targetInstanceType.customMigrationUsed"
							...
							<div class="form-group">
								<label class="control-label col-md-5 col-sm-5 col-xs-12">마이그레이션
									자동 통합 </label>
								<div class="col-md-7 col-sm-7 col-xs-12">
									<select class="form-control" :disabled="!targetInstanceType.customMigrationUsed" v-model="targetInstanceType.autoConverge">
							...
							<div class="form-group">
								<label class="control-label col-md-5 col-sm-5 col-xs-12">마이그레이션
									압축 활성화 </label>
								<div class="col-md-7 col-sm-7 col-xs-12">
									<select class="form-control" :disabled="!targetInstanceType.customMigrationUsed" v-model="targetInstanceType.compressed">
										<option value="inherit" selected>클러스터 설정에서 가져오기</option>
					...
					<div class="x_content" style="display: none;">
						...
						<form class="form-horizontal form-label-left">
							<div class="form-group">
								<div class="checkbox">
									<div class="col-md-5 col-sm-5 col-xs-12">
										<label> <input type="checkbox" v-model="targetInstanceType.highAvailability">
											고가용성 사용
										</label>
									</div>
								</div>
						...
						<form class="form-horizontal form-label-left">
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<select class="form-control" v-model="targetInstanceType.priority">
							...
							<%--<div class="form-group">--%>
								<%--<label class="control-label col-md-5 col-sm-5 col-xs-12">워치독--%>
									<%--모델 </label>--%>
								<%--<div class="col-md-7 col-sm-7 col-xs-12">--%>
									<%--<select class="form-control" v-model="targetInstanceType.watchdogModel">--%>
							...
							<%--<div class="form-group">--%>
								<%--<label class="control-label col-md-5 col-sm-5 col-xs-12">워치독--%>
									<%--작업 </label>--%>
								<%--<div class="col-md-7 col-sm-7 col-xs-12">--%>
									<%--<select class="form-control" v-model="targetInstanceType.watchdogAction" :disabled="targetInstanceType.watchdogModel == 'none'">--%>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content" style="display: none;">
						...
						<form class="form-horizontal form-label-left">
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">첫 번째 장치</label>
								<div class="col-md-9 col-sm-9 col-xs-12">
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">두 번째 장치</label>
								<div class="col-md-9 col-sm-9 col-xs-12">
				...
				<div class="x_panel">
					...
					<div class="x_content" style="display: none">
						<form class="form-horizontal form-label-left">
							...
							<form class="form-horizontal form-label-left">
								<div class="form-group">
									<label class="control-label col-md-5 col-sm-5 col-xs-12">할당할 실제 메모리</label>
									<div class="col-md-7 col-sm-7 col-xs-12">
								...
								<div class="form-group">
									<div class="checkbox">
										<label> <input type="checkbox" v-model="targetInstanceType.memoryBalloon">
											메모리 Balloon 장치 활성화
										</label>
									</div>
								</div>
