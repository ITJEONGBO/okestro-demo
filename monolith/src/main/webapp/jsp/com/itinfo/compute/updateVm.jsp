...
<div class="right_col" role="main" id="vmUpdate">
					...
					<div class="x_content">
						...
						<div class="form-horizontal form-label-left">
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<select v-model="cluster" class="form-control" @change="changeCluster">
										<option v-for="cluster in vmUpdate.clusters"
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<select class="form-control" disabled v-model="vmUpdate.template">
										<option v-for="template in vmUpdate.templates"
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<select v-model="vmUpdate.operatingSystem" class="form-control">
										<option
											v-for="operatingSystem in vmUpdate.operatingSystems"
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<select class="form-control" v-model="instanceType">
										...
										<option v-for="instanceType in vmUpdate.instanceTypes" :value="instanceType.id">{{instanceType.name}}</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<select class="form-control" v-model="vmUpdate.type">
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<input type="text" class="form-control" v-model="vmUpdate.name" @input="checkVmName" placeholder="이름" :maxlength="this.$maxName" required>
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<input type="text" class="form-control" v-model="vmUpdate.description" placeholder="설명">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">용도</label>
								<div class="col-md-9 col-sm-9 col-xs-12">
									<select v-model="vmUpdate.use" class="form-control">
							...
							<div class="form-group" v-for="(linkedDisk, index) in linkedDisks" v-if="linkedDisk.name !='' && linkedDisk.status != 'remove' && linkedDisk.status != 'disconnect'">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">{{linkedDisk.name}}:({{linkedDisk.virtualSize}}GB) </label>
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-3 f-right text-right">
										<button class="btn btn-success btn-sm" data-toggle="modal" data-target=".updateconnectiondiskmodal" v-if="linkedDisk.status === 'linked'" @click="setDiskIndex(index, 'connect')">편집</button>
										<button class="btn btn-success btn-sm" data-toggle="modal" data-target=".updatediskmodal" v-if="linkedDisk.status == 'update' && linkedDisk.lunId == ''" @click="setDiskIndex(index, 'update')">편집</button>
							...
							<div class="form-group">
								...
								<div class="col-md-5 col-sm-5 col-xs-12">
									<select v-model="nic" class="form-control">
										<option value="">비어있음</option>
										<option v-for="nic in vmUpdate.nics" :value="nic.id">{{nic.networkName}}</option>
									</select>
								</div>
								<div class="col-md-4 col-sm-4 col-xs-12 f-right text-right">
									<div class="col-md-12 col-sm-12 col-xs-12">
										<button class="btn btn-default btn-round btn-sm" type="button" :disabled="true">+</button>
										<button class="btn btn-default btn-round btn-sm" type="button" :disabled="true">-</button>
									</div>
								</div>
							</div> -->
...
<%--							<div class="form-group" v-for="(nic, index) in nics">--%>
<%--								<label class="control-label col-md-3 col-sm-3 col-xs-12">{{'nic' + (index + 1)}}</label>--%>

<%--								<div class="col-md-5 col-sm-5 col-xs-12">--%>
<%--									<select v-model="nics[index]" class="form-control">--%>
<%--										<option value="none">비어있음</option>--%>
<%--										<option v-for="nicItem in vmUpdate.nics" :value="nicItem">{{nicItem.networkName}}</option>--%>
<%--									</select>--%>
<%--								</div>--%>
<%--								<div class="col-md-4 col-sm-4 col-xs-12 f-right text-right">--%>
<%--									<div class="col-md-12 col-sm-12 col-xs-12">--%>
<%--										<button class="btn btn-default btn-round btn-sm" type="button" :disabled="nics[index].id == null" v-if="nics.length == index + 1" @click="addNic(index)">+</button>--%>
<%--										<button class="btn btn-default btn-round btn-sm" type="button" :disabled="nics[index].id == null" @click="removeNic(index)">-</button>--%>
<%--									</div>--%>
<%--								</div>--%>
<%--							</div>--%>
						</div>
						...
						<form class="form-horizontal form-label-left">
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">콘솔
									분리 작업</label>
								<div class="col-md-9 col-sm-9 col-xs-12">
									<select class="form-control" v-model="vmUpdate.disconnectAction" disabled>
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<select class="form-control" v-model="vmUpdate.monitors" disabled>
							...
							<!-- <div class="form-group">
								<div class="checkbox">
									<label>
										<input type="checkbox" v-model="vmUpdate.smartcard"> 스마트카드 사용
									</label>
								</div>
							</div>
							<div class="form-group">
								<div class="checkbox">
									<label>
										<input type="checkbox" v-model="vmUpdate.virtIO"> VirtlO 직렬 콘솔 사용
									</label>
								</div>
							</div> -->
						</form>
						...
						<form class="form-horizontal form-label-left">
								...
								<div class="radio">
									...
									<div class="col-md-7 col-sm-7 col-xs-12">
										<select class="form-control" v-model="targetHost" :disabled="pickHost === 'recommendHost'">
											<option v-for="host in vmUpdate.hosts" v-if="host.clusterId === cluster" :value="host.hostId">{{host.hostName}}</option>
										</select>
									</div>
								</div>
							</div>
							...
							<form class="form-horizontal form-label-left">
								<div class="form-group">
									...
									<div class="col-md-7 col-sm-7 col-xs-12">
										<select class="form-control" v-model="vmUpdate.affinity">
								...
								<div class="form-group">
									<div class="checkbox">
										...
										<div class="col-md-7 col-sm-7 col-xs-12">
											<select class="form-control" :disabled="!vmUpdate.customMigrationUsed" v-model="vmUpdate.customMigration">
									...
									<div class="checkbox">
										<div class="col-md-5 col-sm-5 col-xs-12">
											<label><input type="checkbox"
												...
												v-model="vmUpdate.customMigrationDowntimeUsed"> 사용자 정의 마이그레이션 다운 타임
										...
										<div class="col-md-7 col-sm-7 col-xs-12">
											<input type="text" class="form-control" placeholder=""
												:disabled="!vmUpdate.customMigrationDowntimeUsed || !vmUpdate.customMigrationUsed"
												v-model="vmUpdate.customMigrationDowntime">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-7 col-sm-7 col-xs-12">
										<select class="form-control" :disabled="!vmUpdate.customMigrationUsed" v-model="vmUpdate.autoConverge">
								...
								<div class="form-group">
									...
									<div class="col-md-7 col-sm-7 col-xs-12">
										<select class="form-control" :disabled="!vmUpdate.customMigrationUsed" v-model="vmUpdate.compressed">
											<option value="inherit" selected>클러스터 설정에서 가져오기</option>
								...
								<div class="form-group">
									<div class="checkbox">
										<div class="col-md-5 col-sm-5 col-xs-12">
											<label> <input type="checkbox" class="flat" :disabled="vmUpdate.affinity != 'pinned'">
												호스트 CPU 통과
											</label>
										</div>
									</div>
							...
							<form class="form-horizontal form-label-left">
								<div class="form-group">
									...
									<div class="col-md-7 col-sm-7 col-xs-12">
										<input type="text" class="form-control" placeholder="" :disabled="!(vmUpdate.affinity == 'pinned' && pickHost == 'targetHost')">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-5 col-sm-5 col-xs-12">조정
										모드</label>
									<div class="col-md-7 col-sm-7 col-xs-12">
										<select class="form-control" :disabled="!(vmUpdate.affinity == 'pinned' && pickHost == 'targetHost')">
											<option>제한</option>
											<option>기본 설정</option>
											<option>인터리브</option>
										</select>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content" style="display: none;">
						...
						<form class="form-horizontal form-label-left" v-show="vmUpdate.useCloudInit">
							<hr>
							<div class="form-group">
								<label class="control-label col-md-5 col-sm-5 col-xs-12">가상 머신의 호스트 이름 </label>
								<div class="col-md-7 col-sm-7 col-xs-12">
									<input type="text" class="form-control" v-model="vmUpdate.hostName">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-5 col-sm-5 col-xs-12">시간대
									설정 </label>
								<div class="col-md-7 col-sm-7 col-xs-12">
									<select class="form-control" v-model="vmUpdate.timezone" disabled>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<textarea class="form-control" rows="5" v-model="vmUpdate.customScript"></textarea>
								</div>
							</div>
						</form>
					</div>
					...
					<div class="x_content" style="display: none;">
						...
						<form class="form-horizontal form-label-left">
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<select class="form-control" v-model="leaseStorageDomain" :disabled="!highAvailability">
										...
										<option v-for="storageDomain in vmUpdate.leaseStorageDomains" :value="storageDomain.id">{{storageDomain.name}}</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<select class="form-control" v-model="vmUpdate.resumeBehaviour" disabled>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<select class="form-control" v-model="vmUpdate.priority">
							...
							<%--<div class="form-group">--%>
								<%--<label class="control-label col-md-5 col-sm-5 col-xs-12">워치독 모델 </label>--%>
								<%--<div class="col-md-7 col-sm-7 col-xs-12">--%>
									<%--<select class="form-control" v-model="vmUpdate.watchdogModel">--%>
							...
							<%--<div class="form-group">--%>
								...
								<%--<div class="col-md-7 col-sm-7 col-xs-12">--%>
									<%--<select class="form-control" v-model="vmUpdate.watchdogAction" :disabled="vmUpdate.watchdogModel == ''">--%>
							...
							<div class="form-group">
								<div class="checkbox">
									<div class="col-md-3 col-sm-3 col-xs-12">
										<label> <input type="checkbox" v-model="bootImageUse" :disabled="vmUpdate.bootImages == null">CD/DVD
											연결
										</label>
									</div>
									<div class="col-md-9 col-sm-9 col-xs-12">
										<select class="form-control" v-model="bootImage" :disabled="!vmUpdate.bootImageUse">
											<option v-for="image in vmUpdate.bootImages" :value="image.id">{{image.name}}</option>
										</select>
									</div>
								</div>
							</div>
					...
					<div class="x_content" style="display: none">
						...
						<form class="form-horizontal form-label-left">
							...
							<div class="form-group">
								...
								<div class="col-md-3 col-sm-3 col-xs-12">
									<input class="form-control" v-model="vmUpdate.cpuShare" disabled>
								</div>
							</div>
							<!-- <div class="form-group">
							...
							<form class="form-horizontal form-label-left">
								...
								<div class="form-group">
									<div class="checkbox">
										<label> <input type="checkbox" v-model="vmUpdate.memoryBalloon">
											메모리 Balloon 장치 활성화
										</label>
									</div>
								</div>
					...
					<div class="x_content" style="display: none">
						...
						<form class="form-horizontal form-label-left">
							<form class="form-horizontal form-label-left">
								<div class="form-group">
									<div class="checkbox">
										<label><input type="checkbox" v-model="rngEnabled">난수 생성기 활성화</label>
								...
								<div class="form-group" v-show="rngEnabled">
									<label class="control-label col-md-5 col-sm-5 col-xs-12">기간(밀리초)
									</label>
									<div class="col-md-7 col-sm-7 col-xs-12">
										<input class="form-control" v-model="vmUpdate.periodDuration">
									</div>
								</div>
								<div class="form-group" v-show="rngEnabled">
									<label class="control-label col-md-5 col-sm-5 col-xs-12">시간
										당 바이트 수 </label>
									<div class="col-md-7 col-sm-7 col-xs-12">
										<input class="form-control" v-model="vmUpdate.bytesPerPeriod">
									</div>
								</div>
							</form>
							<hr v-show="rngEnabled">
							<p v-show="rngEnabled">
								<strong>장치 소스</strong>
							</p>
							<form class="form-horizontal form-label-left" v-show="rngEnabled">
								<div class="form-group">
									<div class="radio">
										<label><input type="radio" name="deviceSource" v-model="deviceSource" value="urandom">/dev/urandom 소스</label>
										<a data-toggle="tooltip" title="클러스터 버전에 따라 다릅니다. 4.1 이상의 경우 '/dev/unrandom', 4.0 이하의 경우 '/dev/random'"><i class="fa fa-info-circle"></i></a>
									</div>
									<div class="radio">
										<label>
											<input type="radio" disabled name="deviceSource" v-model="deviceSource" value="hwrng">/dev/hwrng 소스
										</label>
									</div>
								</div>
							</form>
		...
		<div class="modal-dialog modal-lg" style="min-width: 1024px">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" @click="connectDisk()">확인</button>
...
<%--								<li @click="flagDisk(2)" role="presentation"><a href="#LUNDisk" data-value="LUN" aria-controls="LUNDisk" role="tab" data-toggle="tab">직접 LUN</a></li>--%>
	...
	<!-- disk update modal -->
	<div class="modal fade updatediskmodal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">크기(GByte)</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" class="form-control" placeholder="#GByte" v-model="disk.virtualSize" disabled>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">크기 확장(GByte)</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" class="form-control" placeholder="#GByte" v-model="disk.virtualSizeExtend">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">이름<span class="text-danger">*</span></label>
						...
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">설명</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" class="form-control" placeholder="설명" v-model="disk.description">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">인터페이스</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<select class="form-control" v-model="disk.diskInterface">
									<option value="ide">IDE</option>
									<option value="virtio_scsi">VirtIO-SCSI</option>
									<option value="virtio">VirtIO</option>
								</select>
						...
						<div class="form-group">
							<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3 col-sm-offset-3">
								<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3 col-sm-offset-3">
									...
									<div class="checkbox" v-if="disk.bootable === true">
										<label> <input type="checkbox" v-model="disk.bootable" @click="changeBootable(false)"> 부팅 가능</label>
									</div>
									<div class="checkbox" v-if="disk.bootable === false">
										<label> <input type="checkbox" v-model="disk.bootable" @click="changeBootable(true)" :disabled="existBootDisk"> 부팅 가능</label>
									</div>
									<!-- <div class="checkbox">
										<label> <input type="checkbox" v-model="disk.sharable"> 공유 가능</label>
									</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" @click="updateDisk()">확인</button>
					<button type="button" class="btn btn-default" @click="cancelUpdateDisk()">취소</button>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- disk remove modal -->
	<div class="modal fade removediskmodal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">
					...
					<h4 class="modal-title" id="myModalLabel">가상 디스크 삭제</h4>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="form-group">
							<label class="control-label col-md-12 col-sm-12 col-xs-12">
								가상 디스크 {{disk.name}} 를 삭제하시겠습니까?
							</label>
						</div>
						<div class="form-group">
							<label class="control-label col-md-12 col-sm-12 col-xs-12" style="margin-top:10px">
								디스크 구성
									<div v-if="disk.bootable === true">&nbsp;&nbsp;- 부팅 가능</div>
									<div v-if="disk.sharable === true">&nbsp;&nbsp;- 공유 가능</div>
									<br/><br/>
									<input type="checkbox" v-model="disk.removePermanently"> 완전 제거
							</label>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" @click="removeTargetDisk()">확인</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">취소</button>
				</div>
			</div>
		</div>
