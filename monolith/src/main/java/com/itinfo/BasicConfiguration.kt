...
import com.itinfo.model.basicConf
...
class BasicConfiguration {
	...
	val postgresUrl: String
		get() = globalProp?.get(PNAME_POSTGRES_JDBC_URL).toString() ?: "localhost"
	val postgresPort: Int
		get() = globalProp?.get(PNAME_POSTGRES_JDBC_PORT).toString().toIntOrNull() ?: 5432
