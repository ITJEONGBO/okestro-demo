...
class VmInterfaceSamplesHistoryEntity(
	...
	class Builder {
		...
		fun build(): VmInterfaceSamplesHistoryEntity = VmInterfaceSamplesHistoryEntity(bHistoryId, bVmInterfaceId, bHistoryDatetime, bReceiveRatePercent, bTransmitRatePercent, bVmInterfaceConfigurationVersion, bReceivedTotalByte, bTransmittedTotalByte, bReceivedDroppedTotalPackets, bTransmittedDroppedTotalPackets)
	}
