...
const [activeSection, setActiveSection] = useState('common_outer');
  ...
  // headerbutton 컴포넌트
const buttons = [
    { id: 'new_btn', label: '새로 만들기',  onClick: () => openPopup('vm_new'), className: 'header-button' },
    { id: 'edit_btn', label: '편집',onClick: () => openPopup('vm_edit'), className: 'header-button'},
    { id: 'delete_btn', label: '삭제', onClick: () => openPopup('delete'), className: 'header-button'},
    { 
        id: 'run_btn', 
        label: (
          <span className="disabled header-button">
            <FontAwesomeIcon icon={faPlay} fixedWidth />
            실행
          </span>
        ), 
    },
    { id: 'pause_btn', label: <><FontAwesomeIcon icon={faPause} fixedWidth/>일시중지</>, onClick: () => console.log('일시중지 clicked'), className: 'header-button' },
    { id: 'stop_btn', label: <><FontAwesomeIcon icon={faStop} fixedWidth/>종료</>, onClick: () => console.log('종료 clicked'), className: 'header-button' },
    { id: 'reboot_btn', label: <><FontAwesomeIcon icon={faRepeat} fixedWidth/>재부팅</>, onClick: () => console.log('재부팅 clicked'), className: 'header-button' },
    { id: 'console_btn', label: <><FontAwesomeIcon icon={faDesktop} fixedWidth/>콘솔</>, onClick: () => console.log('콘솔 clicked'), className: 'header-button' },
    { id: 'snapshot_btn', label: '스냅샷 생성', onClick: () => console.log('스냅샷 생성 clicked'), className: 'header-button' },
    { id: 'migration_btn', label: '마이그레이션', onClick: openModal, className: 'header-button' }
  ];
  const popupItems = [
