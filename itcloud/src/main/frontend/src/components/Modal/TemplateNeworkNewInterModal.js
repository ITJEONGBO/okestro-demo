...
// import { useAddNicFromTemplate, useAddNicFromVM, useEditNicFromTemplate, useEditNicFromVM, useNetworkInterfaceFromVM } from '../../api/RQHook';
...
//   useEffect(() => {
//     console.log('VM ID아아아:', templateId); // vmId 값 확인
//   }, [vmId]);
...
//       });
//     } else {
//         addNicFromTemplate(dataToSubmit, {
//         onSuccess: () => {
