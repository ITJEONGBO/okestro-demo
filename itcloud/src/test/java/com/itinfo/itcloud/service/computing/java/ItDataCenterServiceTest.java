...
class ItDataCenterServiceTest {
    ...
    @Test
    @DisplayName("데이터센터 목록")
    void getList() {
        List<DataCenterVo> dcList = dcService.findAll();
    ...
    void addDatacenter() {
        ...
        Res<Boolean> result =  dcService.add(dc);
    ...
    void editDatacenter() {
        ...
        Res<Boolean> result = dcService.update(dc);
        assertThat(result.getHead().getCode()).isEqualTo(201);
    }
    ...
    void deleteDatacenter() {
        ...
        Res<Boolean> result = dcService.remove(ids);
    ...
    void getEvent() {
        List<EventVo> result = dcService.findAllEventsBy(defaultDcId);
