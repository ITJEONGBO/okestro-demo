...
import com.itinfo.itcloud.model.computing.AffinityGroupMemberVo;
import com.itinfo.itcloud.model.computing.AffinityGroupVo;
import com.itinfo.itcloud.model.computing.AffinityLabelMemberVo;
...
class ItAffinityServiceTest {
    ...
    void addAffinitygroupCluster() {
        ...
        // cluster
        Res<Boolean> result = affinityService.addAffinityGroup(clusterId, true, ag);
...
//        vmLabels.add(IdentifiedVo.builder().id("ecfe4125-d1aa-44ce-8811-d4a4ce8328ce").build());
        ...
        Res<Boolean> result = affinityService.editAffinityGroup(ag);
    ...
    void deleteAffinitygroup() {
        ...
        Res<Boolean> result = affinityService.deleteAffinityGroup(clusterId, true, agId);
    ...
    void getAffinitylabelList() {
        List<AffinityLabelVo> result = affinityService.findAllAffinityLabels();
