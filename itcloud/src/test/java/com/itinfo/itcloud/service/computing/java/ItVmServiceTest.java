...
class ItVmServiceTest {
    ...
    @DisplayName("가상머신 목록")
    void getList() {
        List<VmVo> result = vmService.findAll();
...
//        assertThat(result.size()).isEqualTo(5);
    ...
    void setTemplateList() {
        List<TemplateVo> result = vmService.findAllTemplates();
    ...
    void addVm1() {
        ...
        Res<Boolean> result = vmService.addVm(vm);
...
//                                        .secDevice("CDROM")
    ...
    void editVm() {
        ...
        Res<Boolean> result = vmService.editVm(vm);
    ...
    void deleteVm() {
        ...
        Res<Boolean> result = vmService.deleteVm(id, disk);
    ...
    void startVm() {
        ...
        Res<Boolean> result = vmService.startVm(id);
    ...
    void pauseVm() {
        String id = "89455fd7-770a-427a-962d-ee5782db5615";
        Res<Boolean> result = vmService.pauseVm(id);
    ...
    void stopVm() {
        String id = "89455fd7-770a-427a-962d-ee5782db5615";
        Res<Boolean> result = vmService.powerOffVm(id);
    ...
    void shutdownVm() {
        String id = "89455fd7-770a-427a-962d-ee5782db5615";
        Res<Boolean> result = vmService.shutDownVm(id);
    ...
    void rebootVm() {
        String id = "89455fd7-770a-427a-962d-ee5782db5615";
        Res<Boolean> result = vmService.rebootVm(id);
    ...
    void resetVm() {
        String id = "89455fd7-770a-427a-962d-ee5782db5615";
        Res<Boolean> result = vmService.resetVm(id);
    ...
    void migrateVm() {
        ...
        Res<Boolean> result = vmService.migrateVm(id, hostId);
    ...
    void exportVm() {
        ...
        Res<Boolean> result = vmService.exportOvaVm(exportVo);
    ...
    void getInfo() {
        ...
        VmVo result = vmService.findOne(defaultId);
...
//        assertThat(true).isEqualTo(result.stream().anyMatch(nicVo -> nicVo.getName().equals("vnet0")));
    ...
    void addNic() {
        ...
        Res<Boolean> addNic = vmService.addNic(id, nicVo);
    ...
    void deleteNic() {
        ...
        Res<Boolean> delete = vmService.deleteNic(id, nicId);
    }
...
//        String id = "e929923d-8710-47ef-bfbd-e281434eb8ee";
        ...
        Res<Boolean> result = vmService.addDiskImage(id, image);
    ...
    void deleteDisk() {
        ...
        Res<Boolean> result = vmService.deleteDisk(id, daId, type);
        assertThat(result.getHead().getCode()).isEqualTo(200);
    }
    ...
    void moveDisk() {
        ...
        Res<Boolean> result = vmService.moveDisk(id, daId, disk);
...
//                                SnapshotDiskVo.builder().daId("0450dd6b-1325-4672-8323-9b6fb1802226").build()
        ...
        Res<Boolean> result = vmService.addSnapshot(snapshotVo);
        assertThat(result.getHead().getCode()).isEqualTo(201);
    }
    ...
    void deleteSnapshot() {
        ...
        Res<Boolean> result = vmService.deleteSnapshot(id, snapId);
        assertThat(result.getHead().getCode()).isEqualTo(200);
    }
...
//        assertThat(2).isEqualTo(result.size());
    ...
    void getGuestInfo() {
        GuestInfoVo result = vmService.findGuestFromVm(defaultId);
